...
const drawRectangle = () => {
    ...
    rectangle.setLineWith = lineWidth
    ctx.strokeStyle = color
    rectangle.draw(ctx)
}
...
const drawSquare = () => {
    ...
    const SquareShape = new Square(x, y, side)
    SquareShape.setLineWith = lineWidth
    ctx.strokeStyle = color
    SquareShape.draw(ctx);
}